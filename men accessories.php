  ...
  <body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href=""><i class="fas fa-gift"></i> SHOPPER</a>
        </div>


        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li class=""><a href="homepage2.html"><i class="fas fa-home"></i> HOME</a></li>
        ...
        <form class="navbar-form navbar-left" role="search">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="login2.html"><i class="fas fa-sign-in-alt"></i> LOGIN</a></li>
    ...
    <!--<div class="jumbotron" id="second">
      ...
      <?php
       ...
       ?>
      <hr class="style-two">
      <h6> READY-TO-WEAR FOR MEN  |  Watches for men </h6>
      <hr class="style-two">
      <div class="item">
    <img src="watch1.jpg"/>
